...
async function deployToken(deployer, network, accounts) {
  ...
  //  custruct parameter
  let underlying_ = "0xB835f29cCA30e6AE66125a2e0c03E75665be6aee";
  let comptroller_ = "0xbB78719C0d175B9c523650d1d2C1A9D5a4cf1668";
  let interestRateModel_ = interestRateModel.address;
  let initialExchangeRateMantissa_ = "200000000000000000000000000";
  let name_ = "Golff DAI";
  let symbol_ = "gDAI";
  let decimals_ = 8;
  ...
  // // set reserveFactor 150000000000000000 储备系数
  let reserveFactorMantissa = "150000000000000000";
